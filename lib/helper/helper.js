...
export const loadIgnoredPatterns = function () {
  ...
  if (!atom.config.get('ftp-remote-edit-plus.tree.hideIgnoredNames')) {
    return;
  }
...
export const loadIgnoredFinderPatterns = function () {
  ...
  ignoredFinderNames = (atom.config.get('ftp-remote-edit-plus.finder.ignoredNames')) != null ? atom.config.get('ftp-remote-edit-plus.finder.ignoredNames') : [];
