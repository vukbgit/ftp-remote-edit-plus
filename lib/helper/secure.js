...
export const checkPasswordExists = function () {
  ...
  let passwordHash = atom.config.get('ftp-remote-edit-plus.password');
...
export const setPassword = function (password) {
  ...
  let promise = new Promise((resolve, reject) => {
    ...
    atom.config.set('ftp-remote-edit-plus.password', passwordHash);
...
export const changePassword = function (oldPassword, newPassword) {
  ...
  let promise = new Promise((resolve, reject) => {
    ...
    if (configHash) {
      ...
      // Store in atom config
      atom.config.set('ftp-remote-edit-plus.config', newconfig);
    }
