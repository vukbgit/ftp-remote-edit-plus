...
class DirectoryView extends View {
  ...
  paint(list) {
    ...
    if (!atom.config.get('ftp-remote-edit-plus.tree.sortFoldersBeforeFiles')) {
  ...
  refresh(elementToRefresh) {
    ...
    let sortFoldersBeforeFiles = atom.config.get('ftp-remote-edit-plus.tree.sortFoldersBeforeFiles');
